            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-8 col-md-9">
                        <div class="auth-box2"
                            style="background: rgba(255, 255, 255, 0.2);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(5px);-webkit-backdrop-filter: blur(5px);border: 1px solid rgba(255, 255, 255, 0.3); margin-bottom:60px; height: 620px;">
                            <form id="formId" action="{{ route('register') }}" method="POST" class="rt-form"
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-12">
                                        <h4 class="rt-mb-20 text-gray-500">{{ __('create_account') }}</h4>
                                    </div>
