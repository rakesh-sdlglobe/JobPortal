    ...
    <div class="row" id="login-row">
        <div class="auth-box2">
            <div class="full-height col-12 order-1 order-lg-0">
                <div class="container">
                    <div class="row full-height align-items-center" id="parent-login">
                        <div class="col-xl-5 col-lg-6 col-md-12" id="login-form">
        ...
        <<div class="auth-right-sidebar order-lg-1 order-0" style="position:abolute;">
            <div class="sidebar-bg"
                style="background-image: url({{ asset($cms_setting->login_page_image) }}); width: 100%; height: 900px;">
