...
@section('main')
            ...
            <div class="container position-parent">
                <div class="row">
                            ...
                            <form action="{{ route('website.job') }}" method="GET" id="job_search_form">
                                <div class="jobsearchBox d-flex flex-column flex-md-row bg-gray-10 input-transparent rt-mb-24"
                                    ...
                                    <div class="flex-grow-0">
                                        <button type="submit"
                                            class="btn btn-dark d-block d-md-inline-block " id="icon-badge" >{{ __('find_job') }}</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-xl-6 d-flex align-items-center " >
                        <div class="banner-mockup d-none d-xl-block w-100 text-right flex-item mb-5" >
                            <div class="addimg-1 position-parent video-btn-center mb-2" style="width:500px; margin-left:150px;">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6 mx-auto rt-mb-30">
                    <div class="card jobcardStyle1 counterbox bg-gray-20 hover:bg-gray-10">
                        <div class="card-body" id="card-body-homepage">
    ...
    <div class="most-popular-area rt-pt-100 rt-pt-md-50" style="background: #f6f5f9">
        <div class="container">
                ...
                @foreach ($popular_roles as $role)
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="most-popular-wrap">
                            <div class="most-popular-item pointer">
                                <h3>
                                    <a href="">{{ $role->name }}</a>
                                </h3>
