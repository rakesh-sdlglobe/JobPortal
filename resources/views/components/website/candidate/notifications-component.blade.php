<li title="Employer Login Notification">
    <div class="notification-icon position-relative pointer" title="notifications">
        ...
        <div class="notification-bar">
            <a href="#" onclick="ReadNotification()" class="notification-header">
                <h2 title="{{ __('Click to view all notifications') }}">{{ __('notifications') }}</h2>
                <p title="{{ __('Mark all notifications as read') }}">{{ __('mark_all_as_read') }}</p>
            </a>
            <div class="devider">
            </div>
